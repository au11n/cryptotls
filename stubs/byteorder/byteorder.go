...
func LEPutUint16(b []byte, v uint16) { binary.LittleEndian.PutUint16(b, v) }
...
func LEAppendUint16(b []byte, v uint16) []byte { return binary.LittleEndian.AppendUint16(b, v) }
func LEAppendUint32(b []byte, v uint32) []byte { return binary.LittleEndian.AppendUint32(b, v) }
func LEAppendUint64(b []byte, v uint64) []byte { return binary.LittleEndian.AppendUint64(b, v) }
func BEAppendUint16(b []byte, v uint16) []byte { return binary.BigEndian.AppendUint16(b, v) }
func BEAppendUint32(b []byte, v uint32) []byte { return binary.BigEndian.AppendUint32(b, v) }
func BEAppendUint64(b []byte, v uint64) []byte { return binary.BigEndian.AppendUint64(b, v) }
